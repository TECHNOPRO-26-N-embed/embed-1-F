...
|:--|:--|:--|:--|:--|
| サウンドセンサ | Sound Sensor Module | A0 | 入力 | 音の大きさをアナログ値で取得 |
...
|:---|:---|:---|:---|:---|
| 1 | 2回拍手で音楽の再生・停止ができる | processClap / togglePlaying | A0（サウンドセンサ）, D7（ブザー） | IT-01 |
| 2 | 0.5秒以内の2回拍手でのみ動作する | updateClap / processClap | A0（サウンドセンサ） | IT-02 |
| 3 | 3回拍手で次の音楽に切り替える | processClap / changeMusic | A0（サウンドセンサ）, D7（ブザー） | IT-03 |
